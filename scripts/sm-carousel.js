...
let scroller = document.querySelector('.sm-scroller');
...
let allSlides = document.querySelectorAll('.sm-slide');
...
scroller.addEventListener('pointerdown',setInitialX);
scroller.addEventListener('pointerup',scrollBySwipe);
...
function initializeSlides () {
    if(slideCount<2){
        ...
        slides = document.querySelectorAll('.sm-slide');
    }
    else{
        slides = document.querySelectorAll('.sm-slide');
    }
...
function scrollBySwipe (e) {
    ...
    let distance = e.clientX - initialX;
...
function scrollToLeft () {
    ...
    let activeSlide = document.querySelector('.spotlight');
...
function setArtData () {
    let activeArt = document.querySelector('.spotlight').querySelector('.sm-slide-content');
    let artName = document.querySelector('.art-name');
    let artPrice = document.querySelector('.art-price');
